...
*)
  ...
  printf "SecurePassphrase" | cryptsetup luksFormat /dev/md0 -
  printf "SecurePassphrase" | cryptsetup luksOpen $RAID_DEVICE mapdisk -

  mkfs.ext4 -m 0 -b $FILESYSTEM_BLOCK_SIZE -E stride=$STRIDE,stripe-width=$STRIPE_WIDTH /dev/mapper/mapdisk
...
mount -o defaults,noatime,discard,nobarrier /dev/mapper/mapdisk /pv-disks/nvme
