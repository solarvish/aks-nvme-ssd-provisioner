...
To use, create an AKS cluster and attach a user nodepool with NVMe-enabled size and the `aks-local-ssd` label:


```
az aks nodepool add -g <resourcegrou> --cluster-name <clustername> -n nvme -s Standard_L8s_v2 --labels aks-local-ssd=true -c 1
```
